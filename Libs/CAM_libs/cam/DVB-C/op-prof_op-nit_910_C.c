...
0x00,0x00,0x40,0xCC,0x1F,0x00,0x01,0x01,0x41,0xF5,0x0E,0x44,0x54,0x56,0x4C,0x5F,0x50,0x72,0x6F,0x66,
0x69,0x6C,0x65,0x5F,0x30,0x0A,0x43,0x41,0x4D,0x5F,0x58,0x58,0x5F,0x46,0x54,0x41,0xCC,0x21,0x00,0x02,
0x01,0xC1,0xF6,0x0E,0x44,0x54,0x56,0x4C,0x5F,0x50,0x72,0x6F,0x66,0x69,0x6C,0x65,0x5F,0x30,0x0C,0x43,
0x41,0x4D,0x5F,0x58,0x58,0x5F,0x53,0x63,0x72,0x61,0x6D
};
...
int main(void)
{
   ...
   printf("[BOLD]OP op-prof_op-nit_910_C Start \n");   
   ...
   memcpy(stNitBuffer.au8NitBuffer, op_nit_9010_C, sizeof(op_nit_9010_C));
   stNitBuffer.au8NitBuffer[5] |= ((u8NitVersion << 1) & 0x3E); /* update correct Nit Version */
   strncpy(stNitBuffer.au8NitLabel, "op_nit_9010_C", 16); /* set nit_label */
   stNitBuffer.au8NitLabel[16] = '\0';
   stNitBuffer.u16NitSize = sizeof(op_nit_9010_C);   
   /* set nit_buffer_now */
