...
/* op_nit_0104_C */
uint8 op_nit_0104_C[140] = {
0x40,0xF0,0x8D,0x00,0x86,0xC1,0x00,0x00,0xF0,0x06,0x40,0x04,0x44,0x54,0x56,0x4C,0xF0,0x7A,0x00,0x03,
0x01,0x37,0xF0,0x37,0x44,0x0B,0x05,0x06,0x00,0x00,0xFF,0xF2,0x05,0x00,0x68,0x75,0x0F,0x5F,0x04,0x00,
...
0x01,0x00,0x85,0xF0,0x37,0x44,0x0B,0x04,0x74,0x00,0x00,0xFF,0xF2,0x05,0x00,0x68,0x75,0x0F,0x5F,0x04,
...
int main(void)
{
   ...
   printf("[BOLD]OP op-prof_instl-type1_301_C Start \n");
   ...
   memcpy(stNitBuffer.au8NitBuffer, op_nit_0104_C, sizeof(op_nit_0104_C));
   stNitBuffer.au8NitBuffer[5] |= ((u8NitVersion << 1) & 0x3E); /* update correct Nit Version */
   strncpy(stNitBuffer.au8NitLabel, "op_nit_0104_C", 16); /* set nit_label */
   stNitBuffer.au8NitLabel[16] = '\0';
   stNitBuffer.u16NitSize = sizeof(op_nit_0104_C);   
...
/* stOpInfo.u8EncodingTypeID - n/a
   ...
   /* set CAM_ID in op_info - 33303143 */
   cit_op_SetCicamId(0x33303143);
