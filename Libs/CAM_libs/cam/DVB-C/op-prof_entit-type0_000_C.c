...
int main(void)
{
   ...
   printf("[BOLD]OP op-prof_entit-type0_000_C Start \n");
...
/* stOpInfo.u8EncodingTypeID - n/a
  ...
  /* set operator_info */  
   ...
   /* set CAM_ID in op_info - 30303043 */
   cit_op_SetCicamId(0x30303043);

   /* set empty delivery system descriptor loop - op_tune_1009_C  */
   cit_op_SetDeliveryDscrLoop(op_tune_1009_C);
