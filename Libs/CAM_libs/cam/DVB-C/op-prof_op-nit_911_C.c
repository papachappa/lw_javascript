...
0x00,0x00,0x40,0xCC,0x1F,0x00,0x01,0x01,0x01,0xF5,0x0E,0x44,0x54,0x56,0x4C,0x5F,0x50,0x72,0x6F,0x66,
...
int main(void)
{
   ...
   printf("[BOLD]OP op-prof_op-nit_911_C Start \n");   
   ...
   memcpy(stNitBuffer.au8NitBuffer, op_nit_9011_C, sizeof(op_nit_9011_C));
   stNitBuffer.au8NitBuffer[5] |= ((u8NitVersion << 1) & 0x3E); /* update correct Nit Version */
   strncpy(stNitBuffer.au8NitLabel, "op_nit_9011_C", 16); /* set nit_label */
   stNitBuffer.au8NitLabel[16] = '\0';
   stNitBuffer.u16NitSize = sizeof(op_nit_9011_C);   
   /* set nit_buffer_now */
