...
int main(void)
{
   ...
   printf("[BOLD]OP op-prof_info-type1_701_C Start \n");
   ...
   memcpy(stNitBuffer.au8NitBuffer, op_nit_7001_C, sizeof(op_nit_7001_C));
   stNitBuffer.au8NitBuffer[5] |= ((u8NitVersion << 1) & 0x3E); /* update correct Nit Version */
   strncpy(stNitBuffer.au8NitLabel, "op_nit_7001_C", 16); /* set nit_label */
   stNitBuffer.au8NitLabel[16] = '\0';
   stNitBuffer.u16NitSize = sizeof(op_nit_7001_C);
   /* set nit_buffer_now */
...
/* stOpInfo.u8EncodingTypeID - n/a
   ...
   /* set CAM_ID in op_info - 37303143 */
   cit_op_SetCicamId(0x37303143);
