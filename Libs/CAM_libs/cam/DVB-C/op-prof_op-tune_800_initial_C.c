...
int main(void)
{
   ...
   printf("[BOLD]OP op-prof_op-tune_800_initial_C Start \n");
   ...
   /* op_nit_0101_C */
   u8NitVersion = 0x0;
   memcpy(stNitBuffer.au8NitBuffer, op_nit_0101_C, sizeof(op_nit_0101_C));
   stNitBuffer.au8NitBuffer[5] |= ((u8NitVersion << 1) & 0x3E); /* update correct Nit Version */
   strncpy(stNitBuffer.au8NitLabel, "op_nit_0101_C", 16); /* set nit_label */
   stNitBuffer.au8NitLabel[16] = '\0';
   stNitBuffer.u16NitSize = sizeof(op_nit_0101_C);   
   /* set nit_buffer_now */
...
/* stOpInfo.u8EncodingTypeID - n/a
   ...
   /* set CAM_ID in op_info - 38303043 */
   cit_op_SetCicamId(0x38303043);

   /* set empty delivery system descriptor loop - op_tune_1000_C  */
   cit_op_SetDeliveryDscrLoop(op_tune_1000_C);
