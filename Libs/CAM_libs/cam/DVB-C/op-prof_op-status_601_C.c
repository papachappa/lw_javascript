...
int main(void)
{
   ...
   printf("[BOLD]OP op-prof_op-status_601_C Start \n");
   ...
   stOpInfo.u8InfoVersion = stStatusBody_now.u8InfoVersion + 0; /* +0 already done above */
...
/* stOpInfo.u8EncodingTypeID - n/a
   ...
   /* set CAM_ID in op_info - 36303143 */
   cit_op_SetCicamId(0x36303143);
