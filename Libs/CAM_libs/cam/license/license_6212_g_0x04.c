 ...
 *              Playback License Exchange Response With Errors (0x04)
 * Script name: license_6212_g_0x04.c
 * Preconditions:
 ...
 * Description:
 * - This script supports HTR 6.2.1.2. g (0x04 Play count exceeded).
 */
#include <picoc_cit.h>
...
int main()
{
   ...
   printf("HTR 6.2.1.2.(g): Watch and Buffer Recording, Playback Response With Errors (0x04) \n");
   ...
   stLicenseEvt.u8LicenseStatus  = 0x04; /* Play count exceeded */
