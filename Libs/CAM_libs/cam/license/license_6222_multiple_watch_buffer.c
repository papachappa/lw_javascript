...
/* ---------------------------------------------------------------------------- */ 
/* HTR 6.2.2.2: Multiple License / Retention Limit,
 *              Watch and Buffer Recording
 * Script name: license_6222.c
 * Preconditions:
 * 
 * Description:
 * - This script supports HTR 6.2.2.2.
 */
#include <picoc_cit.h>
...
int main()
{
   ...
   uint8              *pu8LicenseLabel3 = "LicenseD3";
   cit_license_Object stLicenseEvt;

   printf("HTR 6.2.2.2.: Multiple License, Watch and Buffer Recording \n");
