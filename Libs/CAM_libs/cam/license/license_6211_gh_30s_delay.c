 ...
 * Script name: license_6211_gh_30s_delay.c
 * Preconditions:
 ...
 * Description:
 * - This script supports HTR 6.2.1.1. g and h (30s delay).
 */
#include <picoc_cit.h>
...
int main()
{
   ...
   printf("HTR 6.2.1.1.(g,h): Unattended Recording, Delayed Playback Response (30s) \n");
