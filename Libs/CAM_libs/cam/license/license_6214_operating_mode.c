...
/* ---------------------------------------------------------------------------- */ 
/* HTR 6.2.1.4: Operating Mode Transitions From Unattended Mode,
 *              Valid Recording
 * Script name: license_6214.c
 * Preconditions:
 * 
 * Description:
 * - This script supports HTR 6.2.1.4.
 */
#include <picoc_cit.h>
...
int main()
{
   ...
   uint8              u8UriRL = 0;
   uint8              u8EventId = 0;
   uint8              *pu8LicenseLabel = "LicenseA4";
   cit_license_Object stLicenseEvt;

   printf("HTR 6.2.1.4.: Operating Mode Transitions, Valid Recording \n");
