 ...
 *              Valid Recording
 * Script name: license_6212_abcd.c
 * Preconditions:
 *
 * Description:
 * - This script supports HTR 6.2.1.2. a, b, c and d.
 */
#include <picoc_cit.h>
...
int main()
{
   ...
   uint8              u8UriRL = 0;
   uint8              u8EventId = 0;
   uint8              *pu8LicenseLabel = "LicenseA2";
   cit_license_Object stLicenseEvt;

   printf("HTR 6.2.1.2.(a,b,c,d): Watch and Buffer Recording, Valid Recording \n");
