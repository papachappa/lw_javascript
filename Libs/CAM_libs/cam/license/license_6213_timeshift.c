...
/* ---------------------------------------------------------------------------- */ 
/* HTR 6.2.1.3: Timeshift Recording,
 *              Valid Recording
 * Script name: license_6213.c
 * Preconditions:
 * - Check if a timeshift recording can be made on an encrypted service
 *   and then converted to a stored recording.
 * Description:
 * - This script supports HTR 6.2.1.3.
 */
#include <picoc_cit.h>
...
int main()
{
   ...
   uint8              u8UriRL = 0;
   uint8              u8EventId = 0;
   uint8              *pu8LicenseLabel = "LicenseA3";
   cit_license_Object stLicenseEvt;

   printf("HTR 6.2.1.3.: Timeshift Recording, Valid Recording \n");
