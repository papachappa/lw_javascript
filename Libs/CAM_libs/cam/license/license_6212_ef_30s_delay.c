 ...
 *              Delayed Playback License Exchange Response (30s)
 * Script name: license_6212_ef_30s_delay.c
 * Preconditions:
 * - Make Recordings as described in the HTR 6.2.1.2. (a, b, c and d)
 * Description:
 * - This script supports HTR 6.2.1.2. e and f (30s delay).
 */
#include <picoc_cit.h>
...
int main()
{
   ...
   printf("HTR 6.2.1.2.(e,f): Watch and Buffer Recording, Delayed Playback Response (30s) \n");
   ...
   stLicenseEvt.u8PlaybackDelay = 30; /* 30s DELAY */
