 ...
 * Script name: license_6212_g_0x00.c
 * Preconditions:
 ...
 * Description:
 * - This script supports HTR 6.2.1.2. g (set the license status back to 0x00 as a reference playback before testing the playback with errors).
 */
#include <picoc_cit.h>
