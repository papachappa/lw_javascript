 ...
 * Script name: license_6211_i_0x05.c
 * Preconditions:
 ...
 * Description:
 * - This script supports HTR 6.2.1.1. i (0x05 Retention limit exceeded).
 */
#include <picoc_cit.h>
...
int main()
{
   ...
   printf("HTR 6.2.1.1.(i): Unattended Recording, Playback Response With Errors (0x05) \n");
