 ...
 *              Delayed Playback License Exchange Response (infinite)
 * Script name: license_6212_ef_infinite_delay.c
 * Preconditions:
 * - Make Recordings as described in the HTR 6.2.1.2. (a, b, c and d)
 * Description:
 * - This script supports HTR 6.2.1.2. e and f (infinite delay).
 */
#include <picoc_cit.h>
...
int main()
{
   ...
   uint32             eUriVersion;
   uint8              u8EventId = 0;
   uint8              *pu8LicenseLabel = "LicenseDelay";
   cit_license_Object stLicenseEvt;

   printf("HTR 6.2.1.2.(e,f): Watch and Buffer Recording, Delayed Playback Response (infinite) \n");
   ...
   stLicenseEvt.u8PlaybackDelay = 0xFF; /* INFINITE DELAY */
