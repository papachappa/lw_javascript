...
/* op_nit_0102_T */
uint8 op_nit_0102_T[171] = {
0x40,0xF0,0xAC,0x00,0x86,0xC1,0x00,0x00,0xF0,0x06,0x40,0x04,0x44,0x54,0x56,0x4C,0xF0,0x99,0x00,0x01,
0x00,0x85,0xF0,0x57,0x5A,0x0B,0x02,0xD3,0x44,0x40,0x1F,0x84,0x82,0xFF,0xFF,0xFF,0xFF,0x5F,0x04,0x00,
...
0x41,0x4D,0x5F,0x30,0x32,0x5F,0x53,0x63,0x72,0x61,0x6D,0x00,0x03,0x01,0x37,0xF0,0x36,0x5A,0x0B,0x03,
0x04,0x18,0x40,0x1F,0x84,0x82,0xFF,0xFF,0xFF,0xFF,0x5F,0x04,0x00,0x00,0x00,0x40,0xCC,0x21,0x00,0x09,
...
/* CIS string = $compatible[ciplus=1]$ */
uint8 CisData[152] =
{
	...
	0x30,  /*  Tuple link          Link to next tuple */
...
int main(void)
{
   ...
   printf("[BOLD]OP op-prof_instl-type1_200_T Start \n");
   ...
   memcpy(stNitBuffer.au8NitBuffer, op_nit_0102_T, sizeof(op_nit_0102_T));
   stNitBuffer.au8NitBuffer[5] |= ((u8NitVersion << 1) & 0x3E); /* update correct Nit Version */
   strncpy(stNitBuffer.au8NitLabel, "op_nit_0102_T", 16); /* set nit_label */
   stNitBuffer.au8NitLabel[16] = '\0';
   stNitBuffer.u16NitSize = sizeof(op_nit_0102_T);   
...
/* stOpInfo.u8EncodingTypeID - n/a
   ...
   /* set CAM_ID in op_info - 32303054 */
   cit_op_SetCicamId(0x32303054);
