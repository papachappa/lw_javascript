...
int main(void)
{
   ...
   printf("[BOLD]OP op-prof_info-type1_701_T Start \n");
   ...
   memcpy(stNitBuffer.au8NitBuffer, op_nit_7001_T, sizeof(op_nit_7001_T));
   stNitBuffer.au8NitBuffer[5] |= ((u8NitVersion << 1) & 0x3E); /* update correct Nit Version */
   strncpy(stNitBuffer.au8NitLabel, "op_nit_7001_T", 16); /* set nit_label */
   stNitBuffer.au8NitLabel[16] = '\0';
   stNitBuffer.u16NitSize = sizeof(op_nit_7001_T);
   /* set nit_buffer_now */
...
/* stOpInfo.u8EncodingTypeID - n/a
   ...
   stOpInfo.u8ProfileNameLen = 0x08;
   strcpy(stOpInfo.au8ProfileName, "ISO_6937");
   /* set operator_info */  
   cit_op_SetOperatorInfo(&stOpInfo);
   
   /* set CAM_ID in op_info - 37303154 */
   cit_op_SetCicamId(0x37303154);
