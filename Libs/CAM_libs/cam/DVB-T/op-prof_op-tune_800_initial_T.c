...
int main(void)
{
   ...
   printf("[BOLD]OP op-prof_op-tune_800_initial_T Start \n");
   ...
   /* op_nit_0101_T */
   u8NitVersion = 0x0;
   memcpy(stNitBuffer.au8NitBuffer, op_nit_0101_T, sizeof(op_nit_0101_T));
   stNitBuffer.au8NitBuffer[5] |= ((u8NitVersion << 1) & 0x3E); /* update correct Nit Version */
   strncpy(stNitBuffer.au8NitLabel, "op_nit_0101_T", 16); /* set nit_label */
   stNitBuffer.au8NitLabel[16] = '\0';
   stNitBuffer.u16NitSize = sizeof(op_nit_0101_T);   
   /* set nit_buffer_now */
   ...
   stOpInfo.u8InfoVersion = stStatusBody_now.u8InfoVersion + 0;
...
/* stOpInfo.u8EncodingTypeID - n/a
   ...
   /* set CAM_ID in op_info - 38303054 */
   cit_op_SetCicamId(0x38303054);
