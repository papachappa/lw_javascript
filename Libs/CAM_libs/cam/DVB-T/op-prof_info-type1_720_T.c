...
/* op_nit_7005_T */
uint8 op_nit_7005_T[130] = {
0x40,0xF0,0x83,0x00,0x87,0xC1,0x00,0x00,0xF0,0x06,0x40,0x04,0x44,0x54,0x56,0x4C,0xF0,0x70,0x00,0x01,
0x00,0x86,0xF0,0x32,0x5A,0x0B,0x02,0xD3,0x44,0x40,0x1F,0x84,0x82,0xFF,0xFF,0xFF,0xFF,0x5F,0x04,0x00,
...
0x5A,0x0B,0x03,0x04,0x18,0x40,0x1F,0x84,0x82,0xFF,0xFF,0xFF,0xFF,0x5F,0x04,0x00,0x00,0x00,0x40,0xCC,
...
int main(void)
{
   ...
   printf("[BOLD]OP op-prof_info-type1_720_T Start \n");
   ...
   memcpy(stNitBuffer.au8NitBuffer, op_nit_7005_T, sizeof(op_nit_7005_T));
   stNitBuffer.au8NitBuffer[5] |= ((u8NitVersion << 1) & 0x3E); /* update correct Nit Version */
   strncpy(stNitBuffer.au8NitLabel, "op_nit_7005_T", 16); /* set nit_label */
   stNitBuffer.au8NitLabel[16] = '\0';
   stNitBuffer.u16NitSize = sizeof(op_nit_7005_T);
   /* set nit_buffer_now */
