...
int main(void)
{
   ...
   printf("[BOLD]OP op-prof_op-status_604_T Start \n");
   ...
   stStatusBody_now.u8DeliverySystemHint = 0x8;
   ...
   stStatusBody_after.u8DeliverySystemHint  = 0x8;
...
/* stOpInfo.u8EncodingTypeID - n/a
   ...
   /* set CAM_ID in op_info - 36303454 */
   cit_op_SetCicamId(0x36303454);
