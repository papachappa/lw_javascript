...
/* op_nit_0000_T */
uint8 op_nit_0000_T[48] = {
0x40,0xF0,0x31,0x00,0x86,0xC1,0x00,0x00,0xF0,0x06,0x40,0x04,0x44,0x54,0x56,0x4C,0xF0,0x1E,0x00,0x01,
0x00,0x85,0xF0,0x18,0x41,0x09,0x00,0x01,0x01,0x00,0x02,0x01,0x00,0x03,0x01,0x5A,0x0B,0x02,0xD3,0x44,
0x40,0x1F,0x84,0x82,0xFF,0xFF,0xFF,0xFF
};
/* op_nit_0103_T */
uint8 op_nit_0103_T[138] = {

};
...
int main(void)
{
   ...
   printf("[BOLD]OP op-prof_instl-type1_300_T Start \n");
   ...
   stStatusBody_after.u8DeliverySystemHint  = 0x4;
   ...
   /* op_nit_0000_T */
   u8NitVersion = 0x0;
   memcpy(stNitBuffer.au8NitBuffer, op_nit_0000_T, sizeof(op_nit_0000_T));
   stNitBuffer.au8NitBuffer[5] |= ((u8NitVersion << 1) & 0x3E); /* update correct Nit Version */
   strncpy(stNitBuffer.au8NitLabel, "op_nit_0000_T", 16); /* set nit_label */
   stNitBuffer.au8NitLabel[16] = '\0';
   stNitBuffer.u16NitSize = sizeof(op_nit_0000_T);   
   /* set nit_buffer_now */
   ...
   memcpy(stNitBuffer.au8NitBuffer, op_nit_0103_T, sizeof(op_nit_0103_T));
   stNitBuffer.au8NitBuffer[5] |= ((u8NitVersion << 1) & 0x3E); /* update correct Nit Version */
   strncpy(stNitBuffer.au8NitLabel, "op_nit_0103_T", 16); /* set nit_label */
   stNitBuffer.au8NitLabel[16] = '\0';
   stNitBuffer.u16NitSize = sizeof(op_nit_0103_T);   
...
/* stOpInfo.u8EncodingTypeID - n/a
   ...
   /* set CAM_ID in op_info - 33303054 */
   cit_op_SetCicamId(0x33303054);   
