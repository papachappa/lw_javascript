...
int main(void)
{
   ...
   printf("[BOLD]OP op-prof_entit-type0_000_T Start \n");

   /* status_body_0000_T */
   stStatusBody_now.u8InfoVersion = 0x0;
   stStatusBody_now.u8NitVersion  = 0x0;
   stStatusBody_now.u8ProfileType = 0x0;
   ...
   stStatusBody_after.u8ProfileType = 0x0;
...
/* stOpInfo.u8EncodingTypeID - n/a
  ...
  /* set operator_info */  
   ...
   /* set CAM_ID in op_info - 30303054 */
   cit_op_SetCicamId(0x30303054);

   /* set empty delivery system descriptor loop - op_tune_1000_T  */
   cit_op_SetDeliveryDscrLoop(op_tune_1000_T);
