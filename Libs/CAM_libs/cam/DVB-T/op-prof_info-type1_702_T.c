...
int main(void)
{
   ...
   printf("[BOLD]OP op-prof_info-type1_702_T Start \n"); 
   ...
   memcpy(stNitBuffer.au8NitBuffer, op_nit_7002_T, sizeof(op_nit_7002_T));
   stNitBuffer.au8NitBuffer[5] |= ((u8NitVersion << 1) & 0x3E); /* update correct Nit Version */
   strncpy(stNitBuffer.au8NitLabel, "op_nit_7002_T", 16); /* set nit_label */
   stNitBuffer.au8NitLabel[16] = '\0';
   stNitBuffer.u16NitSize = sizeof(op_nit_7002_T);   
   /* set nit_buffer_now */
...
/* stOpInfo.u8EncodingTypeID - n/a
   ...
   strcpy(stOpInfo.au8ProfileName, "ISO_8859-5_short");
   /* set operator_info */  
