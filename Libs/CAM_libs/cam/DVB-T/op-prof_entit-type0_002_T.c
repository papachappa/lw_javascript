...
int main(void)
{
   ...
   uint8 *pu8OperatorProfileName = "DTVL_Profile_1";


   printf("[BOLD]OP op-prof_entit-type0_002_T Start \n"); 
   ...
   stStatusBody_after.u8NitVersion = stStatusBody_now.u8NitVersion; /* +0 already done above */
