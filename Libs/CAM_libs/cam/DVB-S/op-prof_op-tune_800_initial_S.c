...
int main(void)
{
   ...
   printf("[BOLD]OP op-prof_op-tune_800_initial_S Start \n");
   ...
   /* op_nit_0101_S */
   u8NitVersion = 0x0;
   memcpy(stNitBuffer.au8NitBuffer, op_nit_0101_S, sizeof(op_nit_0101_S));
   stNitBuffer.au8NitBuffer[5] |= ((u8NitVersion << 1) & 0x3E); /* update correct Nit Version */
   strncpy(stNitBuffer.au8NitLabel, "op_nit_0101_S", 16); /* set nit_label */
   stNitBuffer.au8NitLabel[16] = '\0';
   stNitBuffer.u16NitSize = sizeof(op_nit_0101_S);   
   /* set nit_buffer_now */
...
/* stOpInfo.u8EncodingTypeID - n/a
   ...
   /* set CAM_ID in op_info - 38303053 */
   cit_op_SetCicamId(0x38303053);
   
   /* set delivery system descriptor loop - op_tune_1000_S  */
