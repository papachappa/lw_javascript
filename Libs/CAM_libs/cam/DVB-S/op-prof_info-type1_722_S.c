...
/* op_nit_7007_S */
uint8 op_nit_7007_S[945] = {
0x40,0xF3,0xB2,0x00,0x87,0xC1,0x00,0x00,0xF0,0x11,0x40,0x04,0x44,0x54,0x56,0x4C,0x4A,0x09,0x00,0x02,0x00,0x86,0x00,0x03,0x02,0x32,0x33,0xF3,0x94,0x00,0x01,0x00,0x86,0xF3,0x65,0x43,0x0B,0x01,0x14,0x50,
0x00,0x01,0x92,0x81,0x02,0x20,0x00,0x05,0x5F,0x04,0x00,0x00,0x00,0x40,0xCC,0x0F,0x10,0x64,0x01,0xC0,0x64,0x04,0x44,0x54,0x56,0x4C,0x04,0x43,0x31,0x30,0x30,0xCC,0x0F,0x10,0x65,0x01,0xC0,0x65,0x04,0x44,
...
0x56,0x4C,0x04,0x43,0x31,0x34,0x38,0xCC,0x0F,0x10,0x95,0x01,0xC0,0x95,0x04,0x44,0x54,0x56,0x4C,0x04,0x43,0x31,0x34,0x39,0x00,0x02,0x00,0x86,0xF0,0x23,0x43,0x0B,0x01,0x21,0x09,0x00,0x01,0x92,0x81,0x02,
0x20,0x00,0x05,0x5F,0x04,0x00,0x00,0x00,0x40,0xCC,0x0E,0x00,0x03,0x01,0x3F,0xFF,0x04,0x44,0x54,0x56,0x4C,0x03,0x65,0x70,0x67
};
...
int main(void)
{
   ...
   printf("[BOLD]OP op-prof_info-type1_722_S Start \n");
   ...
   memcpy(stNitBuffer.au8NitBuffer, op_nit_7007_S, sizeof(op_nit_7007_S));
   stNitBuffer.au8NitBuffer[5] |= ((u8NitVersion << 1) & 0x3E); /* update correct Nit Version */
   strncpy(stNitBuffer.au8NitLabel, "op_nit_7007_S", 16); /* set nit_label */
   stNitBuffer.au8NitLabel[16] = '\0';
   stNitBuffer.u16NitSize = sizeof(op_nit_7007_S);
   /* set nit_buffer_now */
