...
/* op_nit_7005_S */
uint8 op_nit_7005_S[130] = {

};
...
int main(void)
{
   ...
   printf("[BOLD]OP op-prof_info-type1_720_S Start \n");
   ...
   memcpy(stNitBuffer.au8NitBuffer, op_nit_7005_S, sizeof(op_nit_7005_S));
   stNitBuffer.au8NitBuffer[5] |= ((u8NitVersion << 1) & 0x3E); /* update correct Nit Version */
   strncpy(stNitBuffer.au8NitLabel, "op_nit_7005_S", 16); /* set nit_label */
   stNitBuffer.au8NitLabel[16] = '\0';
   stNitBuffer.u16NitSize = sizeof(op_nit_7005_S);
   /* set nit_buffer_now */
...
/* stOpInfo.u8EncodingTypeID - n/a
   ...
   stOpInfo.u8EitPresentFollUsage = 0x2;
   stOpInfo.u8EitScheduleUsage = 0x2;
   stOpInfo.u8ExtendedEventUsage = 0x0;
   stOpInfo.u8SdtOtherTrusted = 0x1;
