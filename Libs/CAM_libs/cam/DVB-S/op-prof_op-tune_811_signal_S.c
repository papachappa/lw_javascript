...
0x43,0x0B,0x01,0x27,0x50,0x00,0x01,0x92,0x81,0x02,0x20,0x00,0x05 /* Highest Frequency DVB-S */
};

int main(void)
{   
   uint32 eError;
   printf("[BOLD]OP op-prof_op-tune_811_signal_S Start \n");

   /* set delivery system descriptor loop - op_tune_1011_S */

   cit_op_SetDeliveryDscrLoop(op_tune_1011_S);
