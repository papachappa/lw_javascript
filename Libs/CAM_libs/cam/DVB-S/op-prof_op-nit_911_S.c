...
int main(void)
{
   ...
   printf("[BOLD]OP op-prof_op-nit_911_S Start \n");   
   ...
   memcpy(stNitBuffer.au8NitBuffer, op_nit_9011_S, sizeof(op_nit_9011_S));
   stNitBuffer.au8NitBuffer[5] |= ((u8NitVersion << 1) & 0x3E); /* update correct Nit Version */
   strncpy(stNitBuffer.au8NitLabel, "op_nit_9011_S", 16); /* set nit_label */
   stNitBuffer.au8NitLabel[16] = '\0';
   stNitBuffer.u16NitSize = sizeof(op_nit_9011_S);   
   /* set nit_buffer_now */
