...
{   
   uint32 eError;
   printf("[BOLD]OP op-prof_op-tune_809_signal_S Start \n");

   /* set delivery system descriptor loop - op_tune_1009_S */

   cit_op_SetDeliveryDscrLoop(op_tune_1009_S);
