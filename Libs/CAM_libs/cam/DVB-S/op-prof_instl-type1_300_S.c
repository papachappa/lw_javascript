...
0x01,0x37,0xF0,0x36,0x43,0x0B,0x01,0x21,0x09,0x00,0x01,0x92,0x81,0x02,0x20,0x00,0x05,0x5F,0x04,0x00,
...
int main(void)
{
   ...
   printf("[BOLD]OP op-prof_instl-type1_300_S Start \n");
   ...
   memcpy(stNitBuffer.au8NitBuffer, op_nit_0103_S, sizeof(op_nit_0103_S));
   stNitBuffer.au8NitBuffer[5] |= ((u8NitVersion << 1) & 0x3E); /* update correct Nit Version */
   strncpy(stNitBuffer.au8NitLabel, "op_nit_0103_S", 16); /* set nit_label */
   stNitBuffer.au8NitLabel[16] = '\0';
   stNitBuffer.u16NitSize = sizeof(op_nit_0103_S);   
...
/* stOpInfo.u8EncodingTypeID - n/a
   ...
   /* set CAM_ID in op_info - 33303053 */
   cit_op_SetCicamId(0x33303053);
