...
/* op_nit_7008_S */
uint8 op_nit_7008_S[130] = {
0x40,0xF0,0x83,0x00,0x87,0xC1,0x00,0x00,0xF0,0x06,0x40,0x04,0x44,0x54,0x56,0x4C,0xF0,0x70,0x00,0x02,
0x00,0x86,0xF0,0x32,0x43,0x0B,0x01,0x21,0x09,0x00,0x01,0x92,0x81,0x02,0x20,0x00,0x05,0x5F,0x04,0x00,
...
0x43,0x0B,0x01,0x14,0x50,0x00,0x01,0x92,0x81,0x02,0x20,0x00,0x05,0x5F,0x04,0x00,0x00,0x00,0x40,0xCC,
0x1D,0x00,0x02,0x01,0xC0,0x65,0x0C,0x44,0x54,0x56,0x4C,0x5F,0x50,0x72,0x6F,0x66,0x69,0x6C,0x65,0x0A,
...
int main(void)
{
   ...
   printf("[BOLD]OP op-prof_info-type1_723_S Start \n");
   ...
   memcpy(stNitBuffer.au8NitBuffer, op_nit_7008_S, sizeof(op_nit_7008_S));
   stNitBuffer.au8NitBuffer[5] |= ((u8NitVersion << 1) & 0x3E); /* update correct Nit Version */
   strncpy(stNitBuffer.au8NitLabel, "op_nit_7008_S", 16); /* set nit_label */
   stNitBuffer.au8NitLabel[16] = '\0';
   stNitBuffer.u16NitSize = sizeof(op_nit_7008_S);
   /* set nit_buffer_now */
