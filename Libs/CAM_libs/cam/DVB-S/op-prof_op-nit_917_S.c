...
/* op_nit_9017_S */
uint8 op_nit_9017_S[212] = {
0x40,0xF0,0xD5,0x00,0x86,0xC1,0x00,0x00,0xF0,0x2B,0x40,0x04,0x44,0x54,0x56,0x4C,0x5F,0x04,0x00,0x00,
0x00,0x40,0xCB,0x0D,0x10,0x1F,0x65,0x6E,0x67,0x4F,0x50,0x5F,0x45,0x6E,0x67,0x5F,0x31,0xCB,0x0E,0x10,
0x1F,0x66,0x72,0x65,0x4F,0x50,0x5F,0x46,0x72,0x65,0x5F,0x31,0x32,0xF0,0x9D,0x00,0x01,0x00,0x86,0xF0,
0x97,0x43,0x0B,0x01,0x14,0x50,0x00,0x01,0x92,0x81,0x02,0x20,0x00,0x05,0x5F,0x04,0x00,0x00,0x00,0x40,
...
int main(void)
{
   ...
   printf("[BOLD]OP op-prof_op-nit_917_S Start \n");   
   ...
   memcpy(stNitBuffer.au8NitBuffer, op_nit_9017_S, sizeof(op_nit_9017_S));
   stNitBuffer.au8NitBuffer[5] |= ((u8NitVersion << 1) & 0x3E); /* update correct Nit Version */
   strncpy(stNitBuffer.au8NitLabel, "op_nit_9017_S", 16); /* set nit_label */
   stNitBuffer.au8NitLabel[16] = '\0';
   stNitBuffer.u16NitSize = sizeof(op_nit_9017_S);  
