...
int main(void)
{
   ...
   printf("[BOLD]OP op-prof_entit-type0_000_S Start \n");
...
/* stOpInfo.u8EncodingTypeID - n/a
  ...
  /* set operator_info */  
   ...
   /* set CAM_ID in op_info - 30303053 */
   cit_op_SetCicamId(0x30303053);


   /* set empty delivery system descriptor loop - op_tune_1000_S  */
   cit_op_SetDeliveryDscrLoop(op_tune_1000_S);
